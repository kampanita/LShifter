    ...
    <div className="flex-1 flex flex-col bg-[#F1F5F9] select-none min-h-0 relative">
      <div className="flex-1 flex flex-col p-2 md:p-4 min-h-0">
        ...
        <div className="flex-1 flex flex-col bg-[#0b121e] rounded-[1.2rem] md:rounded-[2rem] border border-[#1e293b] shadow-2xl overflow-hidden relative min-h-0">
          ...
          {/* HEADER BAR */}
          <div className="h-1 bg-gradient-to-r from-transparent via-[#00a8ff] to-transparent opacity-50 z-20 shrink-0"></div>

          {/* WEEK HEADER - Fixed at top */}
          <div className="grid grid-cols-7 pt-4 md:pt-6 pb-2 md:pb-3 bg-[#0f172a] border-b border-[#1e293b] shrink-0 z-30">
          ...
          {/* SCROLLABLE DAYS GRID CONTAINER */}
          <div className="flex-1 overflow-y-auto min-h-0 relative">
            <div
              className="grid grid-cols-7 p-1 md:p-2 gap-1 md:gap-2 pb-20" /* Extra padding bottom for scroll space */
